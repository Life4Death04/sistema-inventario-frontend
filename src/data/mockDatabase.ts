...
const movements: InventoryMovement[] = [
  {
    ...
    productId: 'prd-1',
    userId: 'usr-2',
    product: { id: 'prd-1', name: 'Amoxicilina 500mg', code: 'AMX-500' },
    user: { id: 'usr-2', fullName: 'Paola Lopez' },
    type: 'IN',
  ...
  },
  {
    ...
    productId: 'prd-2',
    userId: 'usr-3',
    product: { id: 'prd-2', name: 'Ibuprofeno 400mg', code: 'IBU-400' },
    user: { id: 'usr-3', fullName: 'Carlos Mendoza' },
    type: 'OUT',
    adjustmentDirection: null,
  ...
  },
  {
    ...
    productId: 'prd-3',
    userId: 'usr-2',
    product: { id: 'prd-3', name: 'Loratadina 10mg', code: 'LOR-010' },
    user: { id: 'usr-2', fullName: 'Paola Lopez' },
    type: 'OUT',
    adjustmentDirection: null,
  ...
  },
  {
    ...
    productId: 'prd-4',
    userId: 'usr-1',
    product: { id: 'prd-4', name: 'Metformina 850mg', code: 'MET-850' },
    user: { id: 'usr-1', fullName: 'Santiago Rodriguez' },
    type: 'IN',
    adjustmentDirection: null,
  ...
  },
  {
    ...
    productId: 'prd-6',
    userId: 'usr-3',
    product: { id: 'prd-6', name: 'Omeprazol 20mg', code: 'OME-020' },
    user: { id: 'usr-3', fullName: 'Carlos Mendoza' },
    type: 'ADJUSTMENT',
